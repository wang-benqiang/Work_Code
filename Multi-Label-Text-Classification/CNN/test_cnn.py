...
logger = dh.logger_fn("tflog", "logs/my_testing.log")
...
TESTSET_DIR = 'D:\work\多标签分类\Multi-Label-Text-Classification\data/valid_data.json'
MODEL_DIR = 'C:/Users\王本强\Desktop\Multi-Label-Text-Classification\CNN/runs/1578471765\checkpoints'
...
tf.flags.DEFINE_integer("num_classes", 4584, "Number of labels (depends on the task)")
...
def test_cnn():
    ...
    if BEST_OR_LATEST.upper() == 'B':
        ...
        # checkpoint_file = tf.train.latest_checkpoint(FLAGS.checkpoint_dir,latest_filename='model-500')
